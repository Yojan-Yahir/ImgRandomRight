...
public class MainActivity extends AppCompatActivity {
    ...
    aleatorio i1 = new aleatorio(R.drawable.harrypotter,    "Hedwig´s", R.raw.hedwigs);
    aleatorio i2 = new aleatorio(R.drawable.hungergames,    "Hunger Games", R.raw.hungergames);
    aleatorio i3 = new aleatorio(R.drawable.lasventajasdeserinvisible,   "Dexys", R.raw.dexys);
    aleatorio i4 = new aleatorio(R.drawable.shadowhunters, "Bad Dream", R.raw.baddream);
    aleatorio i5 = new aleatorio(R.drawable.sidecidoquedarme,  "If I Saty", R.raw.stay);
    aleatorio i6 = new aleatorio(R.drawable.yoantesdeti,   "Me Before You", R.raw.mebefore);
    aleatorio i7 = new aleatorio(R.drawable.divergent,  "Chance The Rapper", R.raw.chance);
